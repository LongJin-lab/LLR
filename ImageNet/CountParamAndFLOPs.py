...
'convernetv2_38d',
'convernetv2_50d',
'convnext_conver_small_narrow',
'levit_128',
'levit_256d',
'convnext_conver_small',
]
stepsS = ['1',
        #  '2',
        #  '2',
...
print(df)
save_path ='/media3/clm/HighOrderNetStructure/pytorch-image-models/output/ParamsAndFLOPs/20230629/'
if not os.path.exists(save_path):
    os.makedirs(save_path)

df.to_csv(save_path+'ParamsAndFLOPsBaseline.csv')