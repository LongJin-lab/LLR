...
def _cfg_to_cbam(args):
    return {
        "num_classes": args.n_classes,
    }

@MODELS_REGISTRY.register()
@configurable(from_config=_cfg_to_cbam)
def cbam_resnext29_8x64d(num_classes=10):
    return SeResNeXt(cardinality=8, depth=29, num_classes=num_classes, base_width=64)

@MODELS_REGISTRY.register()
@configurable(from_config=_cfg_to_cbam)
def cbam_resnext29_16x64d(num_classes=10):
    return SeResNeXt(cardinality=16, depth=29, num_classes=num_classes, base_width=64)

def test():
    net = cbam_resnext29_8x64d()
