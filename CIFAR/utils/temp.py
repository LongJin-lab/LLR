...
def main():
    ...
    if args.USE_SAM:
        minimizer = eval(args.minimizer)(optimizer, model, rho=1.0, eta=0.01)
            ...
            for epoch in range(start_epoch, num_epochs):
                ...
                if args.USE_SAM:
                    train_metrics = train_one_epoch(
                        ...
                        amp_autocast=amp_autocast, loss_scaler=loss_scaler, model_ema=model_ema, mixup_fn=mixup_fn, use_dls=use_dls, ini_loss=ini_loss)
                else:
                    train_metrics = train_one_epoch(
...
def train_one_epoch(
        ...
        loss_scaler=None, model_ema=None, mixup_fn=None, use_dls=False, ini_loss=None):
