...
class Logger():
    @configurable
    def __init__(self, save_dir, output_dir, output_name, enable_wandb, wandb_project, wandb_name, distributed, time_fmt, args):
        self.time_fmt = time_fmt
        self.output_dir = output_dir
        self.output_name = output_name
        # print('output_dir,output_name',output_dir,output_name)
        self.logger_path = save_dir
    ...
    @classmethod
    def from_config(cls, args,save_dir):
