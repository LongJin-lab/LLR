...
def main(args):
    ...
    if args.swa_lr:
        print('int(0.75*(args.epochs)',int(0.75*(args.epochs)))
        # optimizer = torchcontrib.optim.SWA(opt, swa_start=int(0.75*(args.epochs)), swa_freq=1, swa_lr=args.swa_lr)
        optimizer = torchcontrib.optim.SWA(opt)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if train_stats and args.dls_coe:
        ...
        if args.swa_lr and (epoch + 1) >= int(0.75*(args.epochs)):
